...
public class QRefreshToken extends EntityPathBase<RefreshToken> {
    ...
    private static final long serialVersionUID = 1136585800L;
    ...
    public final com.weshare.api.v1.domain.user.QUser user;
    ...
    public QRefreshToken(Class<? extends RefreshToken> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.weshare.api.v1.domain.user.QUser(forProperty("user")) : null;
    }
